...
public class ConfigLoader {
    ...
    private static ConfigLoader configLoader; // Object of the class

    // Private constructor (so it's not possible to create an instance of the class from outside of the class)
